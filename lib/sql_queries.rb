...
def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal
  "SELECT projects.title, (SUM(pledges.amount)-projects.funding_goal) AS left_over FROM projects JOIN pledges on projects.id = pledges.project_id GROUP BY projects.title HAVING left_over >= 0"
end
